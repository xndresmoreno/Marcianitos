...
Crea el archivo de highscore si no existe:
...
Abre la carpeta del proyecto en VSCode: File → Open Folder... y selecciona Marcianitos.
Instala la extensión Python.
Selecciona el intérprete (el venv): Ctrl+Shift+P → Python: Select Interpreter → elige .venv.
Abre main.py y pulsa F5 para ejecutar o usa Run Python File.
...
.vscode/
highscore.txt
Repositorio oficial: https://github.com/xndresmoreno/Marcianitos
